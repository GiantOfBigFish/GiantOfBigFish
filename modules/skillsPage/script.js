...
var nodes = [
    { name: "Skills" },
    { name: "🍎 SwiftUI", target: [0], value: 58 },
    { name: "🍏 Swift", target: [0, 1], value: 65 },
    { name: "🤖 Android", target: [0, 1, 2], value: 52 },
    { name: "☁️ Azure", target: [0, 3], value: 48 },
    { name: "☕ Java", target: [0, 3, 4], value: 40 },
    { name: "🍃 NodeJS", target: [0, 3, 4, 5], value: 45 },
    { name: "🚀 C#", target: [0, 1, 2], value: 52 },
    ...
    { name: "☁️ AWS", target: [0, 1, 2, 12], value: 57 },
    { name: "💾 mySql", target: [0, 9, 10], value: 30 },
    { name: "🔨 CI/CD", target: [0, 9, 10], value: 37 },
];
